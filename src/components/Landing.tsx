...
export function Landing() {
  ...
  return <main className="landing-page">
    <header><div className="wrap nav"><div className="brand"><img src="/legacy-assets/embedded_asset_1.png" alt="JAAD Logistics" /></div><nav className="navlinks"><a href="#services">Services</a><a href="#coverage">Coverage</a><a href="#track">Track</a><a href="#about">About</a><a href="#contact">Contact</a></nav><div className="navcta"><a href="#contact" className="btn small">Get a quote</a><a href="/admin/login" className="btn ghost small">Admin access</a><button className="btn ghost small" onClick={() => { setAuthMode("login"); setError(""); }}>Sign up / Login</button></div></div></header>
