...
export function Landing() {
  ...
  const verify = () => {
    ...
    if (verification.account.type === "customer") { router.push("/customer"); return; }
    navigate("dashboard");
  };

  return <main className="landing-page">
    <header><div className="wrap nav"><a href="#home" className="brand"><img src="/legacy-assets/embedded_asset_1.png" alt="JAAD Logistics" /></a><nav className="navlinks"><a href="#services">Services</a><a href="#coverage">Coverage</a><a href="#track">Track</a><a href="#about">About</a><a href="#contact">Contact</a></nav><div className="navcta"><a href="#contact" className="btn small">Get a quote</a><a href="/admin/login" className="btn ghost small">Admin access</a><button className="btn ghost small" onClick={() => { setAuthMode("login"); setError(""); }}>Sign up / Login</button></div></div></header>
    ...
    <section id="about"><div className="wrap"><div className="section-head"><div><div className="eyebrow">About JAAD Logistics</div><h2>Moving people forward.</h2></div></div><div className="about-grid"><div className="about-col"><div className="tag">Vision</div><h3>Africa&apos;s most trusted logistics partner</h3><p>A continent fully connected, where businesses move goods across borders without friction and Nigerian enterprise is represented at the highest global standard.</p></div><div className="about-col"><div className="tag">Mission</div><h3>Delivering excellence, every mile</h3><p>Reliable, efficient logistics solutions connecting Nigerian businesses to global markets — freight forwarding, international shipping, road haulage, RoRo transport, customs clearing and end-to-end supply chain management.</p></div><div className="about-col purpose"><div className="tag">Purpose</div><h3>We simplify the complex, so you can build</h3><p>Behind every shipment is a business owner waiting for raw materials, a family expecting goods from abroad, or an entrepreneur expanding into new markets. We remove the friction — customs, multi-modal transport, time-sensitive cargo — so our clients can focus on what they do best.</p></div></div></div></section>
    <section id="contact"><div className="wrap contact-grid"><div><div className="eyebrow">Get a quote</div><h2 style={{ marginBottom: 24 }}>Tell us what&apos;s moving.</h2><div className="form-row"><div className="field"><label>Full name</label><input /></div><div className="field"><label>Company (optional)</label><input /></div></div><div className="form-row"><div className="field"><label>Phone</label><input /></div><div className="field"><label>Email</label><input type="email" /></div></div><div className="form-row"><div className="field"><label>Pickup location</label><input /></div><div className="field"><label>Delivery location</label><input /></div></div><div className="form-row"><div className="field"><label>Goods type</label><input placeholder="e.g. building materials, machinery" /></div><div className="field"><label>Estimated weight</label><input placeholder="e.g. 2 tons" /></div></div><div className="form-row"><div className="field"><label>Notes</label><textarea placeholder="Fragile items, preferred pickup date, truck type..." /></div></div><button className="btn" onClick={() => setNotice("Quote requests are recorded by the team in the connected legacy flow.")}>Request quote</button></div><div><div className="eyebrow">Contact</div><h2 style={{ marginBottom: 24 }}>Reach the team directly.</h2><div className="contact-info"><div className="row"><div className="k">Email</div><div className="v">info@jaadlogistics.com</div></div><div className="row"><div className="k">Phone</div><div className="v">+234 806 147 2153</div></div><div className="row"><div className="k">Address</div><div className="v">64a Olushi Street, Lagos Island, Lagos, Nigeria</div></div><div className="row"><div className="k">Hours</div><div className="v">Monday – Saturday, 8:00am – 6:00pm. Emergency requests may be accommodated.</div></div></div><div className="fraud-note"><strong>Security notice:</strong> JAAD Logistics only sends official email from <strong>@jaadlogistics.com</strong> and never requests payment via Western Union, MoneyGram or cryptocurrency. Report suspicious contact to info@jaadlogistics.com.</div></div></div></section>
    <footer className="site-footer">
      <div className="wrap">
        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a className="whatsapp" href="https://wa.me/2348061472153" target="_blank" rel="noopener" aria-label="WhatsApp">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21h.004c5.46 0 9.91-4.45 9.91-9.91C21.97 6.45 17.5 2 12.04 2zm5.8 14.09c-.24.68-1.4 1.3-1.93 1.34-.5.05-1.02.24-3.4-.71-2.88-1.15-4.74-4.07-4.88-4.26-.14-.19-1.17-1.55-1.17-2.96 0-1.4.74-2.09 1-2.38.26-.28.57-.35.76-.35.19 0 .38 0 .55.01.18.01.42-.07.65.5.24.58.81 2 .88 2.15.07.14.12.31.02.5-.09.19-.14.31-.28.48-.14.16-.29.36-.42.48-.14.14-.28.29-.12.57.16.28.71 1.17 1.52 1.9 1.05.94 1.93 1.23 2.21 1.37.28.14.44.12.6-.07.16-.19.68-.79.86-1.06.19-.28.38-.23.62-.14.24.09 1.55.73 1.81.86.26.14.44.19.5.31.07.11.07.66-.17 1.34z" /></svg>
              </a>
              <a className="email" href="mailto:info@jaadlogistics.com" aria-label="Email">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="4" width="20" height="16" rx="2" /><path d="m2 7 10 6 10-6" /></svg>
              </a>
              <a className="instagram" href="#" data-pending="instagram-handle-needed" aria-label="Instagram" title="Awaiting Instagram handle">
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1" /></svg>
              </a>
            </div>
          </div>
        ...
        <div className="footer-bottom">
          <div className="footer-credit">© 2026 JAAD LOGISTICS. ALL RIGHTS RESERVED. <span style={{ color: "#8a8a8f" }}>· Build 17</span></div>
          <div className="footer-bottom-links">
            <a href="#careers">Careers</a>
            <a href="#privacy">Privacy policy</a>
            <a href="#terms">Terms of service</a>
            <a href="#fraud">Fraud awareness</a>
          </div>
        </div>
      </div>
    </footer>
